        ...
        <div> 
            ...
            <div className="flex items-center gap-[1.6rem]">
              <div className="flex items-center gap-[0.8rem] text-sm ">
                <span  className='text-lavender text-2xl font-serif'>My Links</span>
                <AiOutlineArrowRight className='text-lavender'/>
              </div>
              <MyLinks />
            </div>
          </Reveal>
