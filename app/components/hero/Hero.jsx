...
const Hero = () => {
  return (
    <section className="text-slat-100 overflow-hidden bg-gradient-to-t from-glacier to-antwhite px-8 py-24 tablet:px-12 tablet:py-40 laptop:py-60 h-screen w-auto dark:bg-slate-800  dark:bg-none  ">
