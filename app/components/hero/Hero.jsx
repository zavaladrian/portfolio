...
const Hero = () => {
  return (
    <section className="text-slat-100 overflow-hidden bg-gradient-to-t from-glacier to-antwhite px-8 py-24 tablet:px-12 tablet:py-32 h-screen w-auto dark:bg-slate-800  dark:bg-none  ">
      <div className="relative mx-auto max-w-5xl">   
        ...
        <div className="pointer-events-none relative ">
          <Reveal>
            <h1 className="pointer-events-auto text-6xl font-black text-black md:text-8xl dark:text-antwhite my-5 tablet:my-0">
              Hi, I'm Adrian<span className="text-indigo-400">.</span>
            </h1>
          </Reveal>
          <Reveal>
            <h2 className="pointer-events-auto my-8 text-5xl text-black tablet:my-4 md:text-4xl dark:text-antwhite">
              I'm a{" "}
          ...
          <div className=' flex flex-row space-x-5 my-8 tablet:my-0'>
          <Reveal>
